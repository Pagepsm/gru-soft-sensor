...
※GitHubに関しては初心者で、リポジトリの作成・整理には生成AIに頼ってます。
...
シミュレーター＆ソフトセンサの実装は `notebooks/GRU_soft_sensor_simulation_v14_1_10.ipynb` です。状態再同期に関するコードは `archive/GRU_state_resync_simulation_v2.ipynb` にあります。
